...
var Ke = (t, r, e) => r in t ? He(t, r, { enumerable: !0, configurable: !0, writable: !0, value: e }) : t[r] = e;
...
function z(t) {
  if (ge.useDeprecatedSynchronousErrorHandling) {
    var r = !V;
    if (r && (V = { errorThrown: !1, error: null }), t(), r) {
      var e = V, n = e.errorThrown, i = e.error;
      if (V = null, n)
        throw i;
    }
  } else
...
var we = function(t) {
  ...
  function r(e) {
    ...
    return n.isStopped = !1, e ? (n.destination = e, Re(e) && e.add(n)) : n.destination = ze, n;
  }
...
function Ft(t) {
  ...
  var r = t.connector, e = r === void 0 ? function() {
    return new R();
  } : r, n = t.resetOnError, i = n === void 0 ? !0 : n, o = t.resetOnComplete, u = o === void 0 ? !0 : o, c = t.resetOnRefCountZero, a = c === void 0 ? !0 : c;
  return function(s) {
    var f, y, d, m = 0, _ = !1, l = !1, v = function() {
    ...
    return O(function(A, w) {
      ...
      w.add(function() {
        ...
        error: function(I) {
          l = !0, v(), y = ue(b, i, I), U.error(I);
        },
        complete: function() {
          _ = !0, v(), y = ue(b, u), U.complete();
        }
      }), Ce(A).subscribe(f));
    })(s);
  };
...
function K(t, r, e) {
  ...
  return n ? O(function(i, o) {
    ...
    i.subscribe(L(o, function(a) {
      ...
      var a;
      c = !1, (a = n.complete) === null || a === void 0 || a.call(n), o.complete();
    }, function(a) {
      var s;
      c = !1, (s = n.error) === null || s === void 0 || s.call(n, a), o.error(a);
    }, function() {
      var a, s;
...
(function(t) {
  (function(r, e) {
    ...
    function c(l) {
      return l === "debug" && (l = "log"), typeof console === e ? !1 : l === "trace" && n ? u : console[l] !== void 0 ? o(console, l) : console.log !== void 0 ? o(console, "log") : r;
    }
    function a(l, v) {
    ...
    function y(l, v, b) {
      ...
      function I() {
        ...
        if (!(typeof window === e || !w)) {
          ...
          if (typeof h === e)
            try {
              var F = window.document.cookie, G = F.indexOf(
      ...
      p.name = l, p.levels = {
        ...
        if (typeof h == "string" && p.levels[h.toUpperCase()] !== void 0 && (h = p.levels[h.toUpperCase()]), typeof h == "number" && h >= 0 && h <= p.levels.SILENT) {
          if (A = h, F !== !1 && U(h), a.call(p, h, l), typeof console === e && h < p.levels.SILENT)
            return "No console available for logging";
        } else
          throw "log.setLevel() called with invalid level: " + h;
      }, p.setDefaultLevel = function(h) {
        v = h, I() || p.setLevel(h, !1);
...
var kt = function(t) {
  ...
  return t.reduce(function(r, e) {
    return e.isErr() ? r.isErr() ? T(C(C([], ee(r.error), !1), [e.error], !1)) : T([e.error]) : r.isErr() ? r : E(C(C([], ee(r.value), !1), [e.value], !1));
  }, E([]));
}, Mt = function(t) {
...
ye.fromThrowable;
const Bt = (t, r) => t.messageLifeCycleEventSubject.pipe(
  Ae((e) => e.requestId === r)
), je = (t, r, e) => {
  t.outgoingMessageSubject.next(r);
  const n = t.responseSubject.pipe(
    Ae((o) => o.requestId === r.requestId),
    $(
      (o) => "method" in o ? E(o.payload) : T(o)
    ),
    It()
  ), i = Bt(t, r.requestId).pipe(
    K((o) => {
      k.debug(
        `\u{1F4AC}\u{1F4E3}\u2B07\uFE0F received message lifecycle event
${JSON.stringify(o)}`
      ), e && e(o.eventType);
    }),
    Pt(n)
...
}, jt = (t) => t.dispatchEventSubject.pipe(
  $(qe.transformOutgoingMessage),
  K(({ event: r, payload: e }) => {
    k.debug(`\u{1F535}\u{1F4AC}\u2B06\uFE0F message sent
${JSON.stringify(e)}`), window.dispatchEvent(
      new CustomEvent(r, {
        detail: e
      })
    );
  ...
  ...t,
  requestId: r
}).map((e) => (k.debug(`\u{1F535}\u{1F4AC}\u{1F4AB} message created
${JSON.stringify(e)}`), e)), be = {
  ...
  Object.entries(t).map(([r, e]) => ({ requestType: r, ...e })).filter(
    (r) => Object.values(X).includes(r.requestType)
  )
), Wt = (t) => qt(t).andThen(
  (r) => De({
    method: re.request,
...
), Ht = (t) => t, ne = (t) => _t(t) ? M.fromPromise(Et(t), Ht).andThen(
  (r) => r
) : t, Kt = (t) => (r) => {
  const e = Wt(r);
  if (e.isErr())
    return ne(
      te(
        Q("internal", "", "could not construct outgoing message")
      )
    );
  const n = e.value, i = je(t, n).pipe(
    $(Nt)
  );
  return ne(i);
}, Yt = (t) => (r, e = []) => {
...
}, Zt = (t) => t.outgoingMessageSubject.pipe(
  $((r) => ({
  ...
  Ft()
), $t = (t) => t.incomingMessageSubject.pipe(
  $(qe.transformIncomingMessage),
  K((r) => {
    k.debug(`\u{1F535}\u{1F4AC}\u2B07\uFE0F message received
...
class Qt {
  ...
  takeFromWorktop(r, e) {
    return this.instructions.push(
      'TAKE_FROM_WORKTOP ResourceAddress("' + r + '") Bucket("' + e + '");'
    ), this.buckets.set(e, this.id_allocator++), this;
  }
  takeFromWorktopByAmount(r, e, n) {
    return this.instructions.push(
      'TAKE_FROM_WORKTOP_BY_AMOUNT Decimal("' + r + '") ResourceAddress("' + e + '") Bucket("' + n + '");'
    ), this.buckets.set(n, this.id_allocator++), this;
  }
  takeFromWorktopByIds(r, e, n) {
    return this.instructions.push(
      "TAKE_FROM_WORKTOP_BY_IDS " + this.formatNonFungibleIds(r) + ' ResourceAddress("' + e + '") Bucket("' + n + '");'
    ), this.buckets.set(n, this.id_allocator++), this;
  }
  returnToWorktop(r) {
  ...
  assertWorktopContains(r) {
    return this.instructions.push(
      'ASSERT_WORKTOP_CONTAINS ResourceAddress("' + r + '");'
    ), this;
  }
  assertWorktopContainsByAmount(r, e) {
    return this.instructions.push(
      'ASSERT_WORKTOP_CONTAINS_BY_AMOUNT Decimal("' + r + '") ResourceAddress("' + e + '");'
    ), this;
  }
  assertWorktopContainsByIds(r, e) {
    return this.instructions.push(
      "ASSERT_WORKTOP_CONTAINS_BY_IDS " + this.formatNonFungibleIds(r) + ' ResourceAddress("' + e + '");'
    ), this;
  }
  popFromAuthZone(r) {
  ...
  createProofFromAuthZone(r, e) {
    return this.instructions.push(
      'CREATE_PROOF_FROM_AUTH_ZONE ResourceAddress("' + r + '") Proof("' + e + '");'
    ), this.proofs.set(e, this.id_allocator++), this;
  }
  createProofFromAuthZoneByAmount(r, e, n) {
    return this.instructions.push(
      'CREATE_PROOF_FROM_AUTH_ZONE_BY_AMOUNT Decimal("' + r + '") ResourceAddress("' + e + '") Proof("' + n + '");'
    ), this.proofs.set(n, this.id_allocator++), this;
  }
  createProofFromAuthZoneByIds(r, e, n) {
    return this.instructions.push(
      "CREATE_PROOF_FROM_AUTH_ZONE_BY_IDS " + this.formatNonFungibleIds(r) + ' ResourceAddress("' + e + '") Proof("' + n + '");'
    ), this.proofs.set(n, this.id_allocator++), this;
  }
  createProofFromBucket(r, e) {
    return this.instructions.push(
      'CREATE_PROOF_FROM_BUCKET Bucket("' + r + '") Proof("' + e + '");'
    ), this.proofs.set(e, this.id_allocator++), this;
  }
  cloneProof(r, e) {
    return this.instructions.push(
      'CLONE_PROOF Proof("' + r + '") Proof("' + e + '");'
    ), this.proofs.set(e, this.id_allocator++), this;
  }
  dropProof(r) {
  ...
  callFunction(r, e, n, i) {
    return this.instructions.push(
      'CALL_FUNCTION PackageAddress("' + r + '") "' + e + '" "' + n + '" ' + i.join(" ") + ";"
    ), this;
  }
  callMethod(r, e, n) {
    return this.instructions.push(
      'CALL_METHOD ComponentAddress("' + r + '") "' + e + '" ' + n.join(" ") + ";"
    ), this;
  }
  publishPackage(r, e) {
    return this.instructions.push(
      'PUBLISH_PACKAGE Blob("' + r + '")  Blob("' + e + '");'
    ), this;
  }
  withdrawFromAccount(r, e) {
    return this.instructions.push(
      'CALL_METHOD ComponentAddress("' + r + '") "withdraw" ResourceAddress("' + e + '");'
    ), this;
  }
  withdrawFromAccountByAmount(r, e, n) {
    return this.instructions.push(
      'CALL_METHOD ComponentAddress("' + r + '") "withdraw_by_amount" Decimal("' + e + '") ResourceAddress("' + n + '");'
    ), this;
  }
  withdrawFromAccountByIds(r, e, n) {
    return this.instructions.push(
      'CALL_METHOD ComponentAddress("' + r + '") "withdraw_by_ids" ' + this.formatNonFungibleIds(e) + ' ResourceAddress("' + n + '");'
    ), this;
  }
  createProofFromAccount(r, e) {
    return this.instructions.push(
      'CALL_METHOD ComponentAddress("' + r + '") "create_proof" ResourceAddress("' + e + '");'
    ), this;
  }
  createProofFromAccountByAmount(r, e, n) {
    return this.instructions.push(
      'CALL_METHOD ComponentAddress("' + r + '") "create_proof_by_amount" Decimal("' + e + '") ResourceAddress("' + n + '");'
    ), this;
  }
  createProofFromAccountByIds(r, e, n) {
    return this.instructions.push(
      'CALL_METHOD ComponentAddress("' + r + '") "create_proof_by_ids" ' + this.formatNonFungibleIds(e) + ' ResourceAddress("' + n + '");'
    ), this;
  }
  burnBucket(r) {
  ...
  mintFungible(r, e) {
    return this.instructions.push(
      `MINT_FUNGIBLE ResourceAddress("${r}") Decimal("${e}");`
    ), this;
  }
  build() {
...
const Xt = () => {
  k.debug("\u{1F535} wallet sdk instantiated");
  const t = Vt(), r = () => {
    k.debug("\u{1F535}\u{1F9F9} destroying wallet sdk instance"), t.destroy();
  };
  return {
    ...{
